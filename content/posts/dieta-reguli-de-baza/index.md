...
## Nutritia poate fi atat de confuza.
...
- [<span class = "toc_number toc_depth_1"> 1 </span> [Mancati in mare parte alimente neprocesate](#Eat_Mostly_Unprocessed_Foods)
- [<span class = "toc_number toc_depth_1"> 2 </span> [Manca proteine ​​cu fiecare masa](#Eat_Protein_with_Each_Meal)
- [<span class = "toc_number toc_depth_1"> 3 </span> [Mananca legume cu fiecare masa](#Eat_Veggies_with_Each_Meal)
- [<span class = "toc_number toc_depth_1"> 4 </span> [Limitati raportul de carbohidrati](#Limit_Your_Carb_Intake)
- [<span class = "toc_number toc_depth_1"> 5 </span> [Mananca grasimi bune](#Eat_Good_Fats)
- [<span class = "toc_number toc_depth_1"> 6 </span> [Apa potabila](#Drink_Water)
- [<span class = "toc_number toc_depth_1"> 7 </span> [Don’t Chase Perfection](#Don8217t_Chase_Perfection)
- [<span class = "toc_number toc_depth_1"> 8 </span> [Intrebari frecvente](#Frequently_Asked_Questions)
  - [<span class = "toc_number toc_depth_2"> 8.1 </span> [Ce ar trebui sa mananc?](#What_Should_I_Eat)
  - [<span class = "toc_number toc_depth_2"> 8.2 </span> [Ce sa nu mananc?](#What_should_I_not_eat)
  - [<span class = "toc_number toc_depth_2"> 8.3 </span> [Trebuie sa mananc o masa la fiecare 3 ore?](#Do_I_need_to_eat_a_meal_every_3_hours)
  - [<span class = "toc_number toc_depth_2"> 8.4 </span> [Trebuie sa beau un antrenament dupa scuturarea proteinelor?](#Do_I_need_to_drink_a_protein_shake_post_workout)
  - [<span class = "toc_number toc_depth_2"> 8.5 </span> [Care este un exemplu de plan de masa?](#What8217s_an_example_meal_plan)
  - [<span class = "toc_number toc_depth_2"> 8.6 </span> [Ar trebui sa mananc mai putin / mai mult in zilele de antrenament?](#Should_I_eat_lessmore_on_workout_days)
  - [<span class = "toc_number toc_depth_2"> 8.7 </span> [Cum ar trebui sa arate lista mea alimentara?](#What_should_my_grocery_list_look_like)

## <span id="Eat_Mostly_Unprocessed_Foods"> Manca in mare parte alimente neprocesate </span>
...
## <span id="Eat_Protein_with_Each_Meal"> ** Mananca proteine ​​cu fiecare masa ** </span>
...
## <span id="Eat_Veggies_with_Each_Meal"> Mananca legume cu fiecare masa </span>
...
## <span id="Limit_Your_Carb_Intake"> Limitati raportul de carbohidrati </span>

100 g de paste sau orez sau paine are aproape 400kcal. Acest lucru este inainte de a adauga orice peste ele. Aceste calorii sunt in regula daca vrei sa cresti in greutate, dar nu pentru a mentine sau a pierde in greutate.
...
## <span id="Eat_Good_Fats"> Mananca grasimi bune </span>
...
## <span id="Drink_Water"> **Consumati multe lichide** </span>
...
## <span id="Don8217t_Chase_Perfection"> Nu urmariti perfectiunea </span>
...
### <span id="What_Should_I_Eat"> Ce ar trebui sa mananc? </span>
...
### <span id="What_should_I_not_eat"> Ce ar trebui sa nu mananc? </span>
...
### <span id="Do_I_need_to_eat_a_meal_every_3_hours"> Trebuie sa mananc o masa la fiecare 3 ore? </span>
...
### <span id="Do_I_need_to_drink_a_protein_shake_post_workout"> Trebuie sa beau un shake de proteine ​​dupa antrenament? </span>
...
### <span id="What8217s_an_example_meal_plan"> Care este un exemplu de plan de masa? </span>
...
### <span id="Should_I_eat_lessmore_on_workout_days"> Ar trebui sa mananc mai putin / mai mult in zilele de antrenament? </span>
...
### <span id="What_should_my_grocery_list_look_like"> Cum ar trebui sa arate lista mea alimentara? </span>
