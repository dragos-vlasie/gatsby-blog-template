...
- **Coatele**. Pastrati-le la 45 ° ca atunci cand faceti [Presa deasuprea capului cu bara(Overhead Press)](/exercitii/presa-deasupra-capului-cu-haltera/). Nu va lasati coatele in afara.
...
Tractiunile(pull-ups) sunt in mare parte un exercitiu pentru partea superioara a spatelui si brate, precum [Ramat cu haltera(Barbell Row)](/exercitii/ramat-cu-bara/). Dar va antreneaza altfel spatele. Tractiunile(pull-ups) sunt o miscare verticala ca [Presa deasuprea capului cu bara(Overhead Press)](/exercitii/presa-deasupra-capului-cu-haltera/). Barbell Rows este o miscare orizontala precum [Bench Press(Impinsul cu haltera de la piept)](/exercitii/impinsul-cu-haltera-de-la-piept/). Tractiunile(pull-ups) antreneaza mai putin muschi decat Barbell Rows, deoarece picioarele si soldurile nu fac altceva decat sa atarne.
...
![Tractiuni chin over bar](./assets/tractiuni-top.jpg)
...
Primul mod de a face jumatate de repetare este pornind fiecare repetare cu coatele indoite. Acest lucru scurteaza intervalul de miscare. Iti micsoreaza efortul depus de muschii spatelui. Si construieste obiceiuri periculoase pentru [Indreptari(Deadlifts)](/exercitii/indreptari/), unde fiecare repetare trebuie sa inceapa cu coatele blocate pentru a evita ranile bicepsului. Coborati-va pana la capat:pana cand coatele sunt blocate/fixate. Lasa-ti spatele sa se intinda. Ridica din umeri. Apoi trageti-va in sus, de la o pozitie moarta.
...
Tractiunile(pull-ups)sunt grele, deoarece te obliga sa-ti ridici greutatea corpului din prima zi. Exercitiile de tip Barbell precum genuflexiunile(Squats) sunt mai usor de urcat. Daca nu puteti face [Squat(Genuflexiuni cu haltera)](/exercitii/genuflexiuni-cu-bara/)) cu o greutate care sa fie egala cu greutatea corpului, eliminati pur si simplu placile din bara. In cel mai rau caz incepeti cu bara goala. Dar singura modalitate de a reduce rezistenta la exercitii de greutate corporala precum tractiunile(pull-ups) este sa slabesti. Acest lucru nu este practic. Deci, aveti nevoie de alte modalitati de a face tractiuni(pull-ups) mai usor.
...
Curele pentru tractiuni de calitate pot sustine cu usurinta 80kg / 150lb si mai mult. Nu recomand sa puneti un lant pe centura pe care o utilizati pentru [Squat(Genuflexiuni cu haltera)](/exercitii/genuflexiuni-cu-bara/) and [Indreptari(Deadlifts)](/exercitii/indreptari/)s, aceasta o va deteriora. Obtineti in schimb o curea speciala pentru tractiuni. Sugestii:
...
Treceti la tractiuni(pull-ups) ponderate odata ce puteti face 10 repetari cu o forma buna. Incepeti usor si adaugati greutate la fiecare antrenament. Tractiunile(pull-ups) folosesc muschi mici, asa cum o fac [Bench Press(Impinsul cu haltera de la piept)](/exercitii/impinsul-cu-haltera-de-la-piept/) si Overhead. Adaugand 1kg / 2lb la fiecare antrenament lucreaza, prin urmare, mai mult decat 2,5 kg / 5lb. Imi place sa fac doua seturi de cinci Chinups ponderati la sfarsitul antrenamentului meu. Apoi, imi place sa continui cu un set de Chinups fara greutati pentru cat mai multe repetari.
