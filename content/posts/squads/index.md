...
## Cum sa faci genuflexiuni<a id="cum-sa-faci-genuflexiuni"></a>
...
## Muschii lucrati<a id="muschi-lucrati"></a>
...
## Protectia spatelui inferior<a id="protejarea-partii-inferioare-a-spatelui"></a>
...
## Scoaterea barei de pe suport/aparat (Unracking)<a id="scoaterea-barei"></a>
...
## Dureri la nivelul cotului<a id="durerea-la-nivelul-cotului"></a>
...
## Durere de spate inferioara<a id="dureri-ale-spate-inferior"></a>
...
## Dureri de sold<a id="dureri-de-sold"></a>
...
## Durerea inghinala(groin)<a id="#durerea-inghinala"></a>
...
## Genuflexiuni de intindere(Squats Stretches)<a id="genuflexiuni-intindere"></a>

## Flexibilitatea soldului<a id="flexibilitatea-soldului"></a>
...
## Alternative pentru Power Rack<a id="alternative-pentru-Power-Rack"></a>
...
## Barbell Olympic<a id="barbell-Olympic"></a>
...
## Variatiuni de genuflexiuni(Squats)<a id="variatii-genuflexiuni"></a>

## Genuflexiuni olimpice(Olympic Squat)<a id="#squat-olimpic"></a>
...
## Genuflexiuni “Ass- to-Grass”<a id="ass-to-grass-squat"></a>
...
## Genuflexiuni cu bara in fata(Front Squat)<a id="#front-squat"></a>
...
## Smith Squat<a id="smith-squat"></a>
...
## Dumbbell Squat<a id="dumbbell-quat"></a>
...
## Intrebari frecvente?<a id="intrebari-frecvente?"></a>

## Cum pot faci genuflexiuni cu mai multa greutate?<a id="cum-pot-face-genuflexiuni-cu-mai-multa-greutate?"></a>
...
## Cum imi pot creste genuflexiunea maxima(Squat Max)?<a id="cum-imi-pot-creste-squat-max?"></a>
...
## De cate ori pe saptamana trebuie sa fac genuflexiuni?<a id="de-cate-ori-pe-saptamana-trebuie-sa-fac-genuflexiuni(squat)"></a>
...
## Genuflexiunile(Squats) iti face fundul mai mare?<a id="fundal-va-fi-mai-mare?"></a>
...
## Genuflexiunile (Squats) va fac soldurile mai late?<a id="voi-fi-mai-lat-in-zona-soldurilor?"></a>
...
## De ce imi pocnesc(pop) genunchii cand fac genuflexiuni(Squats)?<a id="de-ce-imi-ies-genunchii-in-evidenta-cand-fac-genuflexiuni(squat)?"></a>
...
## Ce se intampla daca urasc genuflexiunile(Squats)?<a id="ce-se-intampla-daca-urasc-genuflexiunile(squats)?"></a>
