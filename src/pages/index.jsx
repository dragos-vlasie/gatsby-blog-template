...
const Index = ({ data }) => {
  ...
  return (
    <Layout>
      ...
      <Header title="Antrenamente">Fii mai puternic decat scuzele tale</Header>
      <FadeIn>
        <PostWrapper>
          {edges.map(({ node }) => {
